...
function setConformingHeight(el, newHeight) {
    ...
    console.log("element new height: " + newHeight);
    el.height(newHeight);
...
function columnConform(iddiv) {
    ...
    $(iddiv).each(function() {
        var $el = $(this);
        if ($el.position().top != prevPosition && prevPosition != 0) {
            return false;
        }
        row_count++;
        prevPosition = $el.position().top;
    });
    ...
    $(iddiv).each(function() {
        ...
        if (row_idx == row_count) {
            ...
            for (currentDiv = 0; currentDiv < rowDivs.length; currentDiv++) setConformingHeight(rowDivs[currentDiv],
                currentTallest);
            ...
            currentTallest =
                (currentTallest <
                    getOriginalHeight($el)) ? (getOriginalHeight($el)) : (currentTallest);
            row_idx++;
        }
 ...
 $(window).load(function() {
        ...
        $("#menubutton").click(function() {
            ...
            $('.topmenu').toggleClass('topmenu_show');
        });
/*
        $('#s_label').click(function() {
            ...
            $("#s_label").toggleClass('fa-search');

            $("#s_label").toggleClass('fa-search-minus');
        });
*/		
        ...
        $(function() {
            ...
            columnConform('#product_list > div');
        });
    }
