...
function com_install() {
	...
	<br />
	<?php if ($error) { ?>
		CSVI 1.9.2 installation reported errors.
	<?php }
	else { ?>
		CSVI 1.9.2 has been succesfully installed.
		
	<?php } ?>
	<br /><br />
		Start using <?php echo JHTML::_('link', JURI::root().'administrator/index.php?option=com_csvimproved', 'CSVI'); ?>
		<br /><br />
