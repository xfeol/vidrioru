...
define( 'URL', 'http://vidrio.ru/' );
define( 'SECUREURL', 'http://vidrio.ru/' );
...
define('PSHOP_OFFLINE_MESSAGE', 'В данный момент магазин закрыт. Зайдите позже. Приносим извинения за неудобства.');
...
define('VM_PROXY_USER', '4318700@mail.ru');
define('VM_PROXY_PASS', 'Bosco25');
...
define('VM_ONCHECKOUT_LEGALINFO_LINK', '3');
...
define('DOWNLOADROOT', '/home/vidrioru/public_html/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', 'b3254515d521a370fd490d35305e734a');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
define('AFFILIATE_ENABLE', '');
define('PSHOP_ALLOW_FRONTENDADMIN_FOR_NOBACKENDERS', '');
define('PSHOP_IMG_RESIZE_ENABLE', '');
define('PSHOP_IMG_WIDTH', '360');
define('PSHOP_IMG_HEIGHT', '360');
...
define('VM_FEED_TITLE', 'Последние новинки от {storename}');
define('VM_FEED_TITLE_CATEGORIES', '{storename} - Новинки из категории: {catname}');
...
define('VM_FEED_MAX_TEXT_LENGTH', '500');
...
define('VM_LOGFILE_NAME', 'vm_error.log');
define('VM_LOGFILE_LEVEL', 'PEAR_LOG_NOTICE');
