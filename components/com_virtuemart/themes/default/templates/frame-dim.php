...
<br />
<br />
<table width="250px" border="0" cellspacing="15" cellpadding="0" style="border-collapse:collapse; border-spacing: 0 10px;">
<tbody>
...
function table_row($p0, $p1, $p2, $p3, $p4)
{
?>
...
if ($childs_info[0] == 0)
{
	...
	table_header();
	table_row($param[0], $param[1], $param[2], $param[3], $param[4]);
	table_bottom();
