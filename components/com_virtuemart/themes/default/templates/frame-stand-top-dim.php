...
<td width="100" align="center" valign="top">Ножки<br /></td>
...
function table_row($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7,$p8,$p9,$p10,$p11,$p12)
{
?>
...
<td align="middle">
<a href="http://vidrio.ru/images/<?php echo $p10 ?>" title="<?php echo $p11 ?>" rel="lightbox"><img src="http://vidrio.ru/images/<?php echo $p8 ?>" title="<?php echo $p9 ?>" /></a><br />
<?php echo $p9 ?>
</td>
...
if ($childs_info[0] == 0)
{
	...
	table_header();
	table_row($param[0], $param[1], $param[2], $param[3], $param[4], $param[5], $param[6], $param[7], $param[8], $param[9], $param[10], $param[11], $param[12]);
	table_bottom();
