...
class vmTheme extends vmTemplate  {
	...
	function vmTheme() {
		parent::vmTemplate();
		//vmCommonHTML::loadMooTools('none');
	}
		...
		/* Show the Thumbnail with a Link to the full IMAGE */
			...
			if( empty($product['product_full_image'] ) ) {
				...
				if( @$_REQUEST['output'] != "pdf" && $this->get_cfg('useLightBoxImages', 1 ) ) {
					...
					//$text="<img src=\"$imageurl\" width=\"50%\"/>";
				...
				elseif( @$_REQUEST['output'] != "pdf" ) {
					...
					$product_image = "<a href=\"$imageurl\" target=\"_blank\">"
									...
									. "</a>";
/*<img src="http://vidrio.ru/components/com_virtuemart/shop_image/product/resized/_________________5538ad43d19a3_180x180.jpg" height="126" width="180" alt="Журнальный стол  Beauty Style 22" style="border:0;">*/
				}
			}
		}
