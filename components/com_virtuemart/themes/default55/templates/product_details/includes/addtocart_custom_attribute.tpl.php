...
?>
    <div class="vmAttribChildDetail"><label for="<?php echo $attribute['titlevar'] ?>_field"><?php echo $attribute['title'] ?></label></div>
    <div class="vmAttribChildDetail"><input type="text" class="inputboxattrib" id="<?php echo $attribute['titlevar'] ?>_field" size="30" name="<?php echo $attribute['titlevar'].$attribute['product_id'] ?>" /></div>
    <br style="clear: both;" />
