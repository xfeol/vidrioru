...
<table width="100%" cellpadding="2" border="0" cellspacing="1">
  <tr align="left" class="sectiontableheader">
        <th bgcolor="#000000"><?php echo $VM_LANG->_('PHPSHOP_CART_NAME') ?></th>
        <th bgcolor="#000000"><?php echo $VM_LANG->_('PHPSHOP_CART_SKU') ?></th>
	<th bgcolor="#000000"><?php echo $VM_LANG->_('PHPSHOP_CART_PRICE') ?></th>
	<th bgcolor="#000000"><?php echo $VM_LANG->_('PHPSHOP_CART_ACTION') ?>/<?php echo $VM_LANG->_('PHPSHOP_CART_QUANTITY') ?></th>
	<th bgcolor="#000000"><?php echo $VM_LANG->_('PHPSHOP_CART_SUBTOTAL') ?></th>
  </tr>
