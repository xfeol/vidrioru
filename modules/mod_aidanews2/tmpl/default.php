...
foreach ($list as $item) {
	...
	$counter++;
		...
		$patterns = array ('/\[title\]/', '/\[text\]/', '/\[empty\]/', '/\[readmore\]/', '/\[hits\]/', '/\[rating\]/', '/\[author\]/', '/\[image1\]/', '/\[image2\]/', '/\[image3\]/', '/\[date\]/', '/\[comments\]/', '/\[category\]/', '/\[section\]/', '/\[br\]/');
		$replace = array ($item->title, $item->text, '', $item->rm, $item->hits, $item->rating, $item->author, $item->img1, $item->img2, $item->img3, $item->date, $item->comments, $item->category, $item->section, '<br/>');
